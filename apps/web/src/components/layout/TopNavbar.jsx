    ...
    <header className="sticky top-0 z-30 border-b border-white/10 bg-slate-950/85 px-4 py-3 backdrop-blur sm:px-6 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          <button className="grid h-10 w-10 place-items-center rounded-md border border-white/10 text-slate-300 lg:hidden" aria-label="Open navigation">
            <Menu size={20} />
          </button>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="relative grid h-10 w-10 place-items-center rounded-md border border-white/10 text-slate-300" aria-label="Notifications">
            <Bell size={18} />
